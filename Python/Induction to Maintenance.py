...
data = pd.read_csv(r"C:\Users\MichaelDiFelice\Documents\Sanofi\Python\Dashboard\Data\Modified Data\induction_regimen.csv")
...
# Layout of the app
app.layout = html.Div([
html.H1("Induction to Maintenance Flow",style={'textAlign': 'center'}),
